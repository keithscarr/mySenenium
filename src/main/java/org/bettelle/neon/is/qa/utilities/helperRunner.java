...
public class helperRunner extends BlockJUnit4ClassRunner {
	
	 private static final runnerIterator instantiator =
	            new runnerIterator();
	    private Object test;

	    public helperRunner(Class<?> testClass) throws InitializationError {
	        super(testClass);
	    }
